...
const filterByDate = (startDate, endDate, columnMapping) => {
    const filters = {};

    if (startDate) {
        isValidDate(startDate);
        filters[columnMapping.createdAt] = {
    ...
    if (endDate) {
        isValidDate(endDate);
        filters[columnMapping.createdAt] = {
            ...filters[columnMapping.createdAt], // Merge with existing filters, if any
...
module.exports = { parseLimitAndOffset, unmarshalBody, parseSelectFields, parseFilterQueries, filterByDate }