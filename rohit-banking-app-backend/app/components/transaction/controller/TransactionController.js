...
class TransactionController {
  ...
  async getTransaction(settingsConfig, req, res, next) {
    try {
      const response = await this.transactionService.getDatesBetween(new Date(req.body.startDate), new Date(req.body.endDate))
